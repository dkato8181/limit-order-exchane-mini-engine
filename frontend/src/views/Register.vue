    ...
    <div class="max-w-md w-full space-y-8">
      ...
      <div class="bg-white rounded-lg shadow-xl p-8">
        <form @submit.prevent="handleRegister" class="space-y-6">
          ...
          <div>
            ...
            <div class="relative">
              ...
              <input
                ...
                v-model="form.name"
                required
                class="block w-full pl-10 pr-3 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-600 focus:border-transparent transition duration-150 ease-in-out sm:text-sm"
          ...
          <!-- Success Message -->
          <div v-if="success" class="bg-green-50 border-l-4 border-green-400 p-4 rounded">
            <div class="flex">
              <div class="flex-shrink-0">
...
async function handleRegister() {
  try {
    ...
    error.value = err.errors?.email?.[0] || err.message || 'Registration failed. Please try again.'
  } finally {
    loading.value = false
  }
}
