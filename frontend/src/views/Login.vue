<template>
    <div class="w-screen h-screen bg-gray-800">
        <div
            class="flex flex-col items-center justify-center min-h-full px-4 sm:px-6 lg:px-8"
        >
            ...
            <form @submit.prevent="handleLogin" class="p-6">
                <div class="my-5">
                    ...
                    <input
                        id="email"
                        class="outline-2 outline-gray-600 ml-10.5 p-1 rounded text-white"
                        v-model="email"
                        type="email"
                        required
                    />
                ...
                <div class="my-5">
                    ...
                    <input
                        id="password"
                        class="outline-2 outline-gray-600 ml-3 p-1 rounded text-white"
                        v-model="password"
                        type="password"
                        required
                    />
